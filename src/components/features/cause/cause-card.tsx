  ...
  return (
    ...
    >
      ...
      <div className="relative h-48 overflow-hidden">
        <img
          src={cause.image || "/placeholder.svg?height=200&width=400"}
          alt={cause.title}
      ...
      <div className="p-5">
        ...
        <Link href={`/causes/${cause.id}`}>
          <h3 className="font-bold text-lg mb-2 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">{cause.title}</h3>
        </Link>
