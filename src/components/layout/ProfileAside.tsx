...
const ProfileAside = ({ profile }: Props) => {
    ...
    <div className="w-full max-w-sm bg-white rounded-2xl shadow overflow-hidden">
      <div className="flex flex-col items-center w-full mx-auto p-4">
        ...
        <div className="flex mt-2">
          ...
          <a
            href="#"
            className="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 ms-3"
          >
            Profile
          </a>
        </div>
